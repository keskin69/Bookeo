...
public class ApiClient {
	...
	private String basePath = "https://api.bookeo.com/v2";
	...
	public ApiClient() {
		...
		// @UPDATED
		this.dateFormat = Config.APIFORMAT;

		apiBase = basePath + "/bookings?apiKey=" + Configuration.apiKey + "&secretKey=" + Configuration.secretKey;

		// Use UTC as the default time zone.
		this.dateFormat.setTimeZone(TimeZone.getTimeZone("Europe/Budapest"));
		...
		auth.setApiKey(Configuration.apiKey);
		authentications.put("keyAuth", auth);

		auth = new ApiKeyAuth("query", "secretKey");
		auth.setApiKey(Configuration.secretKey);
		authentications.put("secretKey", auth);
	...
	private ClientResponse getAPIResponse(String path, String method, List<Pair> queryParams, Object body,
			byte[] binaryBody, Map<String, String> headerParams, Map<String, Object> formParams, String accept,
	 ...
	 * @param binaryBody
	 *            The request body object - if it is binary, otherwise null
	 * @param headerParams
	...
	public <T> T invokeAPI(String path, String method, List<Pair> queryParams, Object body, byte[] binaryBody,
		...
		if (method.equals("POST")) {
			...
			HttpResponse r = Utils.postJSON(jsonBody, apiBase);
			statusCode = r.getStatusLine().getStatusCode();
			String message = Utils.getResponseMessage(r, jsonBody);

			throw new ApiException(statusCode, message);
		}

		ClientResponse response = getAPIResponse(path, method, queryParams, body, binaryBody, headerParams, formParams,
	 ...
	 * @return The response body in type of string
	 */
	public byte[] invokeBinaryAPI(String path, String method, List<Pair> queryParams, Object body, byte[] binaryBody,
			Map<String, String> headerParams, Map<String, Object> formParams, String accept, String contentType,
